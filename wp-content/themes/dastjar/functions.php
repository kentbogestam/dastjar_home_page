...
function twentytwenty_sidebar_registration() {
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Right Sticky Column', 'twentytwenty' ),
				'id'          => 'sidebar-1',
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Services Menu', 'twentytwenty' ),
				'id'          => 'sidebar-2',
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Contact Menu', 'twentytwenty' ),
				'id'          => 'sidebar-3',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty' ),
			)
		)
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Download Menu', 'twentytwenty' ),
				'id'          => 'sidebar-4',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty' ),
			)
		)
	...
	register_sidebar(
		array_merge(
			$shared_args,
			array(
				'name'        => __( 'Social Icon', 'twentytwenty' ),
				'id'          => 'sidebar-5',
				'description' => __( 'Widgets in this area will be displayed in the second column in the footer.', 'twentytwenty' ),
			)
		)
